...
import Delete from '../usage/Forms/Delete';
import './Show.css';
const ShowAll = props => {
    ...
    return (
        <div style={{display: "flex", justifyContent:'space-between'}}>
            ...
            {blocked.map((User, idx)=>{
                return <div  style={{overflow: "scroll",width: "200px",height: "150px"}}  key={idx}>
                 {User.project}
                 {User.due}
            ...
            {progress.map((pro,i)=>{
              return <div  style={{overflow: "scroll",width: "200px",height: "150px"}}  key={i}>
               {pro.project}
               {pro.due}
